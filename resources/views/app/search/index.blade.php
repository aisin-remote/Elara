                ...
                <div class="mt-4 space-y-3">
                    @forelse($results as $result)
                        ...
                        <a href="{{ $result->url }}" class="flex min-h-20 items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm hover:border-orbit-300 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 dark:hover:border-orbit-700">
                            <span class="grid size-11 shrink-0 place-items-center rounded-xl bg-orbit-50 text-orbit-700 dark:bg-orbit-950 dark:text-orbit-300"><x-icon :name="match($result->result_type) { 'project' => 'projects', 'feature' => 'sparkles', 'feature request', 'project request' => 'hourglass', 'task' => 'tasks', 'supporting' => 'supporting', 'file' => 'files', 'member' => 'team', default => 'messages' }" /></span>
