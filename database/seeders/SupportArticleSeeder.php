...
class SupportArticleSeeder extends Seeder
{
    public function run(): void
    {
        $articles = [
            ...
            ['category' => 'Getting started', 'slug' => 'manage-subscription-and-invoices', 'title' => 'Unlimited workspace access', 'body' => "Orbitra does not apply package quotas to workspace members, projects, application storage, integrations, or CSV and PDF exports.\n\nInfrastructure storage capacity and limits imposed directly by connected providers still apply."],
            ['category' => 'Integrations', 'slug' => 'connect-team-tools', 'title' => 'Connect Slack, Drive, GitHub, or Zoom', 'body' => "Workspace owners connect providers from Settings, then Integrations. Orbitra requests only the scopes needed for the action shown in each provider card.\n\nDisconnecting revokes provider access when supported and removes locally encrypted tokens."],
            ['category' => 'FAQ', 'slug' => 'are-files-private', 'title' => 'Are uploaded files private?', 'body' => 'Yes. Orbitra stores project files on a private disk and streams previews or downloads only after checking workspace, project, and file permissions.'],
            ...
            ['category' => 'FAQ', 'slug' => 'how-do-plan-limits-work', 'title' => 'How do plan limits work?', 'body' => 'Orbitra checks limits on the server when inviting members, creating active projects, uploading files, connecting integrations, and exporting reports. Changing HTML in the browser cannot bypass them.'],
        ];
